...
import FindCartelera from '../../cartelera/components/FindCartelera';
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul className="navbar-nav">
                    ...
                    {role === "USER" ? <li className="nav-item">
                        <Link className="nav-link" to="/compras/find-orders">
                            <FormattedMessage id="project.compras.header.orders"/>
                        </Link>
                    </li> : null}

                    {role === "ADMIN" ?
                        <Link className="nav-link" to="/compras/deliver-tickets">
                            <FormattedMessage id="project.compras.header.ticketvalidate"/>
                        </Link>
                    : null}
