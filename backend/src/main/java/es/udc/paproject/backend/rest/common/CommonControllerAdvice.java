...
public class CommonControllerAdvice {
	...
	private final static String PELICULA_EMPEZADA_CODE = "project.exceptions.PeliculaEmpezadaException";
	...
	@ExceptionHandler(PeliculaEmpezadaException.class)
	@ResponseStatus(HttpStatus.FORBIDDEN)
	@ResponseBody
	public ErrorsDto handlePeliculaEmpezadaException(PeliculaEmpezadaException exception, Locale locale) {

		String errorMessage = messageSource.getMessage(PELICULA_EMPEZADA_CODE,
				null, PELICULA_EMPEZADA_CODE, locale);
